...
def clv_address_log_export_sqlite_10(client, args, db_path, table_name):
    ...
    # client.context = {'active_test': False}
    address_log = client.model('clv.address.log')
    address_log_browse = address_log.browse(args)
...
def clv_address_log_import_sqlite_10(client, args, db_path, table_name, address_table_name, res_users_table_name):

...
def ir_sequence_export_sqlite_10(client, args, db_path, table_name, conn_string):
    ...
    for ir_sequence_reg in ir_sequence_browse:
        ...
        use_date_range = None
        if ir_sequence_reg.use_date_range:
            use_date_range = ir_sequence_reg.use_date_range
...
def ir_sequence_import_sqlite_named_10(client, args, db_path, table_name, conn_string, input_code, output_code):
